...
for (resample_percent in c(0, 50, 100, 150, 200, 250, 300, 350, 400)){
  if (file.exists(file.path(data_dir, TMC, tissue, 'resample', paste('quad_', cluster_num, '_100-', radius, '_', hr, '_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = '')))){
     if(!file.exists(file.path(data_dir, TMC, tissue, 'resample', paste('AUCROC_', cluster_num, '_500_1_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = '')))){
    #if (T){
      if(!file.exists(file.path(data_dir, TMC, tissue, 'resample', paste('pred_intensities_', cluster_num, '_500_1_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = '')))){
        load(file.path(data_dir, TMC, tissue, 'resample', paste('marked_simulated_pattern_', cluster_num, '_500_1_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = '')))
        ...
        filename1 = file.path(data_dir, TMC, tissue, 'resample', paste('pred_cell_type_', cluster_num, '_500_1_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = ''))
        save(pred_cell_pattern_df, file = filename1)
        
        filename2 = file.path(data_dir, TMC, tissue, 'resample', paste('pred_intensities_', cluster_num, '_500_1_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = ''))
      ...
      filename3 = file.path(data_dir, TMC, tissue, 'resample', paste('AUCROC_', cluster_num, '_500_1_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = ''))
      save(aucroc, file = filename3)
      
      print(aucroc) 
      
      # load(file.path(data_dir, TMC, tissue, 'resample', paste('quad_', cluster_num, '_100-', radius, '_', hr, '_', intensity_type, '_across3_', img_idx, '_resample5_', resample_percent, '_self_dummy_grid_eps_20.Rda', sep = '')))
      ...
      # print(results)
      # save(results, file = file.path(data_dir, TMC, tissue, 'resample', paste('devi_', cluster_num, '_100-', radius, '_', hr, '_', intensity_type, '_', tissue, '_', tissue, '_across3_', img_idx, '_resample5_', resample_percent,'_self_dummy_grid_eps_20.Rda', sep = '')))
    }
  }
}
