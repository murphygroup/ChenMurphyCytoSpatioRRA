...
for (radii in seq(100, r, 100)){
  load(file.path(data_dir, TMC, tissue, 'random_tile', paste('quad_', n, '_', radii, '_', hr, '_', intensity_type, '_across3_', img_idx, '_tile_', tile_side, '_', tile_num, '_self_dummy_grid_eps_20.Rda', sep = '')))
...
load(file.path(data_dir, TMC, tissue, 'random_tile', paste('quad_', n, '_', r, '_', hr, '_', intensity_type, '_across3_', img_idx, '_tile_', tile_side, '_', tile_num, '_self_dummy_grid_eps_20.Rda', sep = '')))

Quad_all_all = Quad_all
Quad_all_all$moadf = concatenated_quad
print(concatenated_quad[1:5,])
save(Quad_all_all, file = file.path(data_dir, TMC, tissue, 'random_tile', paste('quad_', n, '_100-', r, '_', hr, '_', intensity_type, '_across3_', img_idx, '_tile_', tile_side, '_', tile_num, '_self_dummy_grid_eps_20.Rda', sep = '')))
