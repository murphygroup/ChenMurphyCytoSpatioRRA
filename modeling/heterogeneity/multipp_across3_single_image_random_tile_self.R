...
load(file.path(data_dir, TMC, tissue, 'random_tile', paste('cell_list_', n, '_', intensity_type, '_across3_', img_idx, '_tile_', tile_side, '_', tile_num, '.Rda', sep = '')))
...
filename = file.path(data_dir, TMC, tissue, 'random_tile', paste('quad_', n, '_', r, '_', hr, '_', intensity_type, '_across3_', img_idx, '_tile_', tile_side, '_', tile_num, '_self_dummy_grid_eps_20.Rda', sep = ''))
